...
def main() -> None:
    ...
    parser.add_argument("--name", default=os.getenv("MEMORY_STORE_NAME", "step-08-skill-system-baseline"))
    ...
    memory_store = project_client.beta.memory_stores.create(
        ...
        description="Step 08 user profile, summaries, direct memory, and procedural memory.",
    )
