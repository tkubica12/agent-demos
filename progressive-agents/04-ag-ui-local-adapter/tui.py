...
from agui_client import AGUIConversation
...
class AGUITui(App):
    ...
    def __init__(self, url: str) -> None:
        super().__init__()
        self.conversation = AGUIConversation(url)
...
def main() -> None:
    ...
    parser.add_argument("--url", default="http://127.0.0.1:8088/agui")
    args = parser.parse_args()
    AGUITui(args.url).run()
