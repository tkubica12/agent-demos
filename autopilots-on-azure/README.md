...
- Live-validated direct CLI reconciliation on 2026-07-17: `meeting-decision-record` was detected as unprovenanced CLI drift, quarantined, safely recreated on the next bridged turn, appended to schema-v2 `records.jsonl`, and marked `reconciled`.
