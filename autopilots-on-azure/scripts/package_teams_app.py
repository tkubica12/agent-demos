...
def enable_targeted_messages_preview(manifest: str) -> str:
    ...
    payload["supportsChannelFeatures"] = "tier1"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Package the OpenClaw Autopilot Teams app manifest for sideloading.")
    ...
    package_path = Path(args.output) if args.output else out_dir / "openclaw-autopilot-teams.zip"
