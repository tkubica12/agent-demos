...
The project started as OpenClaw-on-Azure and the current implementation still contains OpenClaw-specific names in documentation, scripts, Terraform variables, image names, bridge prompts, Teams metadata, and generated local configuration.
