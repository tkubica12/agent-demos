...
def main() -> None:
    ...
    bridge_tfvars = read_json(APPS_DIR / "generated.bridge.auto.tfvars.json")
    data_volume_name = bridge_tfvars.get("openclaw_data_volume_name", "openclaw-bridge-e2e-clean")
    gateway_token = bridge_tfvars.get("openclaw_gateway_token", "")
