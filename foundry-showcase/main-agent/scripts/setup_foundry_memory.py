...
def main() -> None:
    ...
    parser.add_argument("--name", default=os.getenv("MEMORY_STORE_NAME", "foundry-showcase-main"))
    ...
    memory_store = project_client.beta.memory_stores.create(
        ...
        description="Foundry Showcase user profile, summaries, direct memory, and procedural memory.",
    )
